...
/**
 * 2012-04-07
 * $Id: DataSetStringTest.java 206 2012-04-07 14:06:09Z whirlwind $
 */
public class DataSetStringTest {
	private IMocksControl control;
	private DataSet dataSet;
	private DataSetString value;

	@Before
	public void setUp() throws Exception {
		control = createStrictControl();
		dataSet = control.createMock(DataSet.class);
		value = new DataSetString(dataSet, "myval");
	}
	...
	public void testConstruct_ThrowsIfDateSetIsNull() throws Exception {
		new DataSetString(null, "myval");
	}
	
	@Test (expected=NullPointerException.class)
	public void testConstruct_ThrowsIfNameIsNull() throws Exception {
		new DataSetString(dataSet, null);
	}
	
	@Test
	public void testCalculate_Ok() throws Exception {
		String val = new String("foobar");
		expect(dataSet.getString("myval")).andReturn(val);
		control.replay();
	...
	public void testCalculate_ThrowsIfDataSetThrows() throws Exception {
		expect(dataSet.getString("myval"))
