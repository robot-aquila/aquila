...
public class AC_BuyAboveZeroTest {
	...
	public static Collection<Object[]> dataProvider() {
		...
		{new Double[]{-3d, -4d, -3d, -2d},  false}, // all < 0
		{new Double[]{-2d,  1d,  2d,  3d},	false}, // a < 0
		{new Double[]{ 2d, -1d,  2d,  3d},	false}, // b < 0
		{new Double[]{ 2d,  1d, -2d,  3d},	false}, // c < 0
		{new Double[]{ 2d,  1d,  2d, -3d},	false}, // d < 0
		{new Double[]{ 1d,  2d,  1d,  1d},	false}, // b >= a
		{new Double[]{ 3d,  2d,  1d,  1d},	false}, // c <= b
		{new Double[]{ 3d,  1d,  2d,  1d},	false}, // d <= c
	...
	public AC_BuyAboveZeroTest(Double[] values, boolean matched) {
		this.values = values;
	...
	public void testMatches() throws Exception {
		...
		IPatternMatcher matcher = new AC_BuyAboveZero(o);
