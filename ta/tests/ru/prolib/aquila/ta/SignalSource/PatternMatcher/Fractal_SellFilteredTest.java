...
public class Fractal_SellFilteredTest {
	...
	{new Double[]{-1d,-1d,-1d,-1d,-1d },-2d,	false}, // нету дна
	{new Double[]{-1d, 0d,-1d, 0d, 0d }, 0d,	false}, // дно не низшее 
	{new Double[]{ 0d,-1d,-1d, 0d, 0d }, 0d,	false}, // дно не низшее
	
	{new Double[]{ 0d, 0d,-1d,-1d, 0d }, 0d,	false}, // дно не низшее
	{new Double[]{ 0d, 0d,-1d, 0d,-1d }, 0d,	false}, // дно не низшее
	{new Double[]{ 1d,-2d,-4d,-1d,-3d },-6d,	false}, // выше фильтра
	...
	public Fractal_SellFilteredTest(Double[] values, Double filter,
			boolean matched)
	{
		this.values = values;
		this.filter = filter;
	...
	public void testMatches() throws Exception {
		...
		IPatternMatcher matcher = new Fractal_SellFiltered(hi, f);
