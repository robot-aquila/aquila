...
public class TLSIntrgStrategyTest {
	...
	private TLSIntrgStrategy strategy;
	...
	public void setUp() throws Exception {
		...
		strategy = new TLSIntrgStrategy(sources, queue);
	...
	public void testGetForInterrogating() throws Exception {
		...
		assertSame(list, strategy.getForInterrogating());
