...
/**
 * Кэш строки таблицы инструментов.
 */
public class SecurityCache extends CacheEntry {
	 ...
	 */
	public SecurityCache(Integer lotSize, Double maxPrice, Double minPrice,
	...
	public boolean equals(Object other) {
		...
		if ( other.getClass() != SecurityCache.class ) {
			return false;
		}
		SecurityCache o = (SecurityCache) other;
