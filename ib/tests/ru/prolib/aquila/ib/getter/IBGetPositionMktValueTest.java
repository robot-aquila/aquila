...
import ru.prolib.aquila.ib.getter.IBGetPositionMktValue;

/**
 * 2012-12-30<br>
 * $Id: IBGetPositionMktValueTest.java 433 2013-01-14 22:37:52Z whirlwind $
 */
public class IBGetPositionMktValueTest {
	private static IBEventUpdatePortfolio event;
	private static IBGetPositionMktValue getter;
	...
	public static void setUpBeforeClass() throws Exception {
		...
		getter = new IBGetPositionMktValue();
	}

	@Test
	public void testGet() throws Exception {
		assertEquals(2.0d, getter.get(event), 0.001d);
	...
	public void testEquals() throws Exception {
		...
		assertTrue(getter.equals(new IBGetPositionMktValue()));
	...
	public void testHashCode() throws Exception {
		assertEquals(new HashCodeBuilder(20121231, 223901)
