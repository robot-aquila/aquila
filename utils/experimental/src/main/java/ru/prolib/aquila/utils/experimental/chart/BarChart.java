...
public interface BarChart {
	...
	ChartElement getTopAxis();
	ChartElement getLeftAxis();
	ChartElement getRightAxis();
	ChartElement getBottomAxis();
    ...
    BarChart setCategoryAxisRenderer(AxisRenderer renderer);
    BarChart setValueAxisRenderer(AxisRenderer renderer);
