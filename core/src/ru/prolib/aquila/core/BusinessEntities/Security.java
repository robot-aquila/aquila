...
public interface Security {
	 ...
	 * указанного количества бумаги. Для расчетов использует значение стоимости
	 * шага цены. Если стоимость шага определена, то для расчета объема
	 * используется конвертация цены в деньги и последующее умножение. Если
	 * стоимость шага не определена, то для расчета объема цена просто
	 * умножается на указанное количество. 
	 * <p>
	 * @param price цена
