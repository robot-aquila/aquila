...
public class CandleOpenSeriesTest {
	...
	public void setUp() throws Exception {
		...
		candles = new SeriesImpl<Candle>("foo");
		...
		candles.add(candle2);
		candles.add(candle3);
		series = new CandleOpenSeries(candles);
	}
	
	@Test
	public void testGetId() {
		assertEquals("foo.OPEN", series.getId());
	}
	
	@Test
	public void testGet0() throws Exception {
		assertEquals(CDecimalBD.of("143280"), series.get());
	}
	
	@Test
	public void testGet1() throws Exception {
		assertEquals(CDecimalBD.of("144440"), series.get(0));
		assertEquals(CDecimalBD.of("143230"), series.get(1));
		assertEquals(CDecimalBD.of("143280"), series.get(2));
	}
	...
	public void testGetLID() {
		...
		series = new CandleOpenSeries(candlesMock);
