...
public class CandleVolumeSeriesTest {
	...
	public void testGet0() throws Exception {
		assertEquals(CDecimalBD.of(11990L), series.get());
	}
	
	@Test
	public void testGet1() throws Exception {
		assertEquals(CDecimalBD.of(39621L), series.get(0));
		assertEquals(CDecimalBD.of(12279L), series.get(1));
		assertEquals(CDecimalBD.of(11990L), series.get(2));
	}
