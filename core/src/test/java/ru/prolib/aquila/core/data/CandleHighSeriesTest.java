...
public class CandleHighSeriesTest {
	...
	public void testGet0() throws Exception {
		assertEquals(CDecimalBD.of("143320"), series.get());
	}
	
	@Test
	public void testGet1() throws Exception {
		assertEquals(CDecimalBD.of("144440"), series.get(0));
		assertEquals(CDecimalBD.of("143390"), series.get(1));
		assertEquals(CDecimalBD.of("143320"), series.get(2));
	}
	...
	public void testGetLID() {
		...
		series = new CandleHighSeries(candlesMock);
