 ...
 * исходной серии.
 * <p>
 * Алгоритм несколько отличается от работы алгоритма TAMath#qema
 * <p>
 ...
 * null-значений.
 * <p>
 * В реализации TAMath#qema осуществляется пропуск period, а не period-1
 * элементов. Другим отличием является то, что TAMath#qema переносит
