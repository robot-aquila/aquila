...
public class Transaction {
	 ...
	 * Определение времени отправки запроса рассматривается как начало
	 * транзакции.
	 * <p>
	 * @return true - если транзакция начата, false - если не начата
	 */
	public synchronized boolean isStarted() {
		return requestTime == null ? false : true;
	}
	 ...
	 * <p>
	 * Данный признак расчитывается по внутреннему состоянию транзакции.
	 * Определение времени ответа рассматривается как завершение транзакции.
	 * <p> 
	 * @return true - если транзакция завершена, false - если не завершена
	 */
	public synchronized boolean isExecuted() {
		return responseTime == null ? false : true;
	}
