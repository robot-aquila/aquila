...
/**
 * 2012-10-25<br>
 * $Id: OrderSetTakeProfitPriceTest.java 298 2012-10-27 16:07:51Z whirlwind $
 */
public class OrderSetTakeProfitPriceTest {
	private static IMocksControl control;
	private static EditableOrder order;
	private static OrderSetTakeProfitPrice setter;
	
	@BeforeClass
	public static void setUpBeforeClass() throws Exception {
		control = createStrictControl();
		order = control.createMock(EditableOrder.class);
		setter = new OrderSetTakeProfitPrice();
	}
	...
	public void testSet() throws Exception {
		...
		for ( int i = 0; i < fixture.length; i ++ ) {
			...
			if ( (Boolean) fixture[i][2] ) {
				order.setTakeProfitPrice((Double) fixture[i][1]);
			}
			control.replay();
	...
	public void testEquals() throws Exception {
		...
		assertTrue(setter.equals(new OrderSetTakeProfitPrice()));
