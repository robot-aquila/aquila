...
/**
 * 2012-08-12<br>
 * $Id: SetSecurityMaxPriceTest.java 252 2012-08-12 16:51:42Z whirlwind $
 */
public class SecuritySetMaxPriceTest {
	private EditableSecurity security;
	private SecuritySetMaxPrice setter;
	private IMocksControl control;

	@Before
	public void setUp() throws Exception {
		setter = new SecuritySetMaxPrice();
	}
	...
	public void testEquals() throws Exception {
		...
		assertTrue(setter.equals(new SecuritySetMaxPrice()));
