...
public class TerminalStartSequenceTest {
	...
	private TerminalStartSequence sequence;
	...
	public void setUp() throws Exception {
		...
		sequence = new TerminalStartSequence(terminal, started);
	...
	public void testRun_Ok() throws Exception {
		started.countDown();
		starter.start();
		terminal.setTerminalState(eq(TerminalState.STARTED));
	...
	public void testEquals() throws Exception {
		...
		int foundCnt = 0;
		TerminalStartSequence x = null, found = null;
		do {
			x = new TerminalStartSequence(vTerm.get(), vSig.get());
