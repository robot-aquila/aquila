	...
	implements DDEObservableService, DDEService
{
	...
	public void onConnectConfirm(String topic) {
		dispatcher.dispatch(new DDETopicEvent(OnConnect(), getName(), topic));
	}

	@Override
	public boolean onData(String topic, String item, byte[] dataBuffer) {
		dispatcher.dispatch(new DDEDataEvent(OnData(), getName(),
	...
	public void onDisconnect(String topic) {
		dispatcher.dispatch(new DDETopicEvent(OnDisconnect(), getName(),topic));
	}

	@Override
	public void onRegister() {
		dispatcher.dispatch(new DDEEvent(OnRegister(), getName()));
	}

	@Override
	public void onTable(DDETable table) {
		dispatcher.dispatch(new DDETableEvent(OnTable(), getName(), table));
	}

	@Override
	public void onUnregister() {
		dispatcher.dispatch(new DDEEvent(OnUnregister(), getName()));
	}
